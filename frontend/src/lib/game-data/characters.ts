...
export const CLASS_STARTING_INVENTORY: Record<CharacterClass, StartingItem[]> = {
  ...
  Wizard: [
    { item_name: 'Spellbook', quantity: 1, properties: { type: 'spellcasting' } },
    { item_name: 'Arcane Focus (Staff)', quantity: 1, properties: { type: 'spellcasting' } },
  ...
  Cleric: [
    ...
    { item_name: 'Shield', quantity: 1, properties: { type: 'armor', ac_bonus: 2 } },
    { item_name: 'Holy Symbol', quantity: 1, properties: { type: 'spellcasting' } },
  ...
  Druid: [
    ...
    { item_name: 'Leather Armor', quantity: 1, properties: { type: 'armor', ac: 11 } },
    { item_name: 'Druidic Focus', quantity: 1, properties: { type: 'spellcasting' } },
    { item_name: "Explorer's Pack", quantity: 1, properties: { type: 'pack' } },
  ],
  Bard: [
  ...
  Sorcerer: [
    ...
    { item_name: 'Arcane Focus (Crystal)', quantity: 1, properties: { type: 'spellcasting' } },
    { item_name: "Dungeoneer's Pack", quantity: 1, properties: { type: 'pack' } },
    { item_name: 'Dagger', quantity: 1, properties: { type: 'weapon', damage: '1d4 piercing' } },
  ],
  Warlock: [
    { item_name: 'Light Crossbow', quantity: 1, properties: { type: 'weapon', damage: '1d8 piercing' } },
    { item_name: 'Bolts', quantity: 20, properties: { type: 'ammunition' } },
    { item_name: 'Arcane Focus (Wand)', quantity: 1, properties: { type: 'spellcasting' } },
    { item_name: "Scholar's Pack", quantity: 1, properties: { type: 'pack' } },
    { item_name: 'Dagger', quantity: 1, properties: { type: 'weapon', damage: '1d4 piercing' } },
  ],
}

export function getConModifier(con: number): number {
  return Math.floor((con - 10) / 2)
}

export function calculateHpMax(characterClass: CharacterClass, con: number): number {
  const hitDie = CLASS_HIT_DIE[characterClass]
  return hitDie + getConModifier(con)
}
